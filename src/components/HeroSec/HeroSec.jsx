  ...
  return (
    <div className="hero-sec-container">
        ...
        <div className="hero-sec-content">
            <Button className="hero-sec-top-btn rounded-pill rose-btn black-txt">Trending Now</Button>
                ...
                <Card.Body className='card-text'>
                    ...
                    {/* <div className="artist">
                        <div className="artist-pp">
                            <img style={{width:"100%"}} src={artist} alt="artist" />
                        </div>
                    ...
                    <Button variant=" rounded-pill rose-btn black-txt hero-btm-btn hero-btm-btn2">See collection</Button>
                </Card.Body>
            </Card>
        </div>
